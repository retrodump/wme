...
//////////////////////////////////////////////////////////////////////////
ResizableImageOld::ResizableImageOld()
{
	m_IsDirty = true;
	m_UpdateId = 0;
...
//////////////////////////////////////////////////////////////////////////
void ResizableImageOld::Display(ElementCollection* elementCol, const SpriteDrawingParams& params)
{
	if (!m_Texture) return;
...
//////////////////////////////////////////////////////////////////////////
bool ResizableImageOld::SetTexture(const WideString& fileName, Ogre::ColourValue colorKey)
{
	SAFE_DELETE(m_Texture);
...
//////////////////////////////////////////////////////////////////////////
void ResizableImageOld::SetPos(int posX, int posY)
{
...
//////////////////////////////////////////////////////////////////////////
void ResizableImageOld::SetSize(int width, int height)
{
...
//////////////////////////////////////////////////////////////////////////
void ResizableImageOld::UpdateGeometry(Viewport* viewport, bool absolutePos)
{
	if (!m_Texture) return;
...
//////////////////////////////////////////////////////////////////////////
int ResizableImageOld::GetCorrectedWidth() const
{
...
//////////////////////////////////////////////////////////////////////////
int ResizableImageOld::GetCorrectedHeight() const
{
	int middleWidth, middleHeight, middleTileWidth, middleTileHeight;
	GetCorrectedSize(middleWidth, middleHeight, middleTileWidth, middleTileHeight);
...
//////////////////////////////////////////////////////////////////////////
void ResizableImageOld::GetCorrectedSize(int& middleWidth, int& middleHeight, int& middleTileWidth, int& middleTileHeight) const
{
...
//////////////////////////////////////////////////////////////////////////
void ResizableImageOld::BuildTiles()
{
	m_Tiles.clear();
...
//////////////////////////////////////////////////////////////////////////
void ResizableImageOld::FillTiles(Viewport* viewport, bool absolutePos)
{
...
//////////////////////////////////////////////////////////////////////////
void ResizableImageOld::GetTextureCoordinates(ImageTile::TileType type, Ogre::FloatRect& rect)
{
	float leftColLeft = 0;
...
// DocumentAwareObject
//////////////////////////////////////////////////////////////////////////
bool ResizableImageOld::LoadFromXml(TiXmlElement* rootNode)
{
...
//////////////////////////////////////////////////////////////////////////
bool ResizableImageOld::SaveToXml(TiXmlElement* rootNode)
{
...
// IRenderableProvider
//////////////////////////////////////////////////////////////////////////
void ResizableImageOld::GetRenderables(IRenderableProvider::RenderableList& renderableList)
{
...
//////////////////////////////////////////////////////////////////////////
const Ogre::MaterialPtr& ResizableImageOld::getMaterial(void) const
{
	return m_Texture->GetMaterial();
}

//////////////////////////////////////////////////////////////////////////
void ResizableImageOld::getRenderOperation(Ogre::RenderOperation& op)
{
...
//////////////////////////////////////////////////////////////////////////
void ResizableImageOld::getWorldTransforms(Ogre::Matrix4* xform) const
{
	*xform = Ogre::Matrix4::IDENTITY;
}

//////////////////////////////////////////////////////////////////////////
const Ogre::LightList& ResizableImageOld::getLights(void) const
{
	// N/A
